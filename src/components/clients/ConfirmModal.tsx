...
export default function ConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative card-dark-strong p-6 w-full max-w-md mx-auto">
        {/* Header */}
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={onConfirm}
            className={`flex-1 py-3 px-4 rounded-xl transition-colors disabled:opacity-50 ${getConfirmButtonClasses()}`}
            disabled={isLoading}
          >
            {isLoading ? (
